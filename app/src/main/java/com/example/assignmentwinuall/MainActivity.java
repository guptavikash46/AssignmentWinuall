...
import com.example.assignmentwinuall.ViewModel.PlacesViewModel;
...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView placeRecyclerView = findViewById(R.id.mainActivityRecyclerView);
        ...
        placesViewModel.getAllPlaces().observe((LifecycleOwner) this, new Observer<List<Places>>() {
            @Override
    ...
    public void checkWeather(View view){
        ...
        placesViewModel.insertPlace(new Places(placeText));
    }
}
